...
export function defaultChallengeConfig(): ChallengeConfig {
  return {
    ...
    messageTemplates: {
      ...
      proof_received: 'Video buktimu sudah kami terima ✅ dan sedang diverifikasi oleh tim kami. Mohon tunggu informasi selanjutnya melalui WhatsApp ini. Untuk info lebih lanjut hub : {{contact}}',
